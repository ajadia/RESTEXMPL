...
public class DataNotFoundExceptionMapper implements ExceptionMapper<DataNotFoundException> {
	...
	public Response toResponse(DataNotFoundException ex) {
		// TODO Auto-generated method stub - Here we can cath the exception and prepare the msz, response and send it back to user.
				ErrorMessage errorMessage =  new ErrorMessage(ex.getMessage(), 404, "https://ankitjadia.org");
